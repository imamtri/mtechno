...
<html class="no-js">
	...
	<meta name="author" content="M-Technology" />
			...
			<div class="row">
				<div class="col-md-3">
					...
					<ul class="contact-info">
						<li><i class="icon-map"></i>198 West 21th Street, Suite 721 Metro NY 10016</li>
						<li><i class="icon-phone"></i>+ 1235 2355 98</li>
						<li><i class="icon-envelope"></i><a href="#">info@mtechnology.com</a></li>
						<li><i class="icon-globe"></i><a href="#">www.mtechnology.com</a></li>
					</ul>
				</div>
